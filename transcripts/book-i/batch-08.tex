...
% supplied in \supplied{} anywhere in this batch.
%
...
\hand{jo}{- Tall girl, brown hair, reading time table (yellow). Night out
...
\hand{jo}{Returned from \uncertain[low]{Cohn} Gallery. June 30, 49. \quad Sold by
...
2500 + returned water color - Shore Acres \uncertain{=} 500. & & & & \\
...
records from the other side, and the figure closing that line is 500 and not
2500: compared with the photograph at the Whitney's published size on
19 September 2026, at Michel Hua's question, and the three digits are clear.
The sign before it is two short strokes and is offered as « = »; a multiplication
sign would sit as well on the ink. What the 500 values is the returned
water colour, since the three payments below --- 500, 1700 and 300 --- make the
2500 on their own. A machine's comparison, not the human check the edition
reserves « checked » for. « immitation » is as written. « Cohn Gallery » is
...
The titles are in Josephine Hopper's hand, in the same block as the size and
date; they are set as work headings so that the index of works finds them, and
nothing about the reading changes. Hotel Room's title stands after its size, run
into the first line of the description as « Hotel Room - Tall girl », and is
split out here at that point.}
...
\hand{jo}{Returned from \uncertain[low]{Cohn} Gallery, June 30 \struck{1948} 1949 .
...
\hand{jo}{Nov. 2, \ill[under paper]{}\\
Justi\ill[under paper]{}\\
the Sk\ill[under paper]{}\\
Nov. 13 -\\
* French\ill[under paper]{}\\
the Cam\ill[under paper]{}}
...
Each of them is marked \ill[under paper]{}, and unlike leaves 66, 71 and 75 there
...
and the day of « May 20, 36 » is cut by the fore-edge. As on leaf 80, the two
titles are in Josephine Hopper's hand and are set as work headings so that the
index of works finds them.}
