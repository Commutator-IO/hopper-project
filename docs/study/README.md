...
edition's transcriptions and derived data, prepared for submission to
*Digital Humanities Quarterly* or the *Journal of the Text Encoding
Initiative*. It is an experiment in method with the Hopper corpus as its
occasion, and it says so on its first page.

- `hopper-ledgers-study.pdf` — the note, 72 pages.
- `hopper-ledgers-study.txt` — a plain-text export of the same.
