\chapter{Sources}
\begingroup\setlength{\parindent}{0pt}\setlength{\parskip}{5pt plus 1pt}\everypar{\hangindent=1.5em\hangafter=1}
...
\emph{Hopper Ledgers}, \url{https://hopper.commutator.io}. Transcriptions of the six ledgers (46 batches, 543 sheets) and the four notebooks, first machine pass by Claude Opus 5 and Claude Fable 5.1, 5 to 13 September 2026, unchecked against the photographs by a person except where a leaf's note says otherwise. The \texttt{.tex} under \texttt{transcripts/} is the source of record; the tables in the appendix are read from \texttt{src/content/}. Method: \texttt{/method/}; Book IV's reader: \texttt{docs/book-iv-method.md}; the glossary of forms: \texttt{/schema/}.
...
This note, its tables, its figures and its LaTeX sources: © 2026 Michel Hua, Creative Commons Attribution 4.0 International (CC BY 4.0), \url{https://creativecommons.org/licenses/by/4.0/}. Attribution: \q{Michel Hua, \emph{The Books Kept at 3 Washington Square North}, draft of 13 September 2026, drafted with Claude Fable 5.1, \url{https://github.com/Commutator-IO/hopper-project/tree/main/docs/study}}.

The edition's software and its generated data, including every file the tables and figures are built from: CC0 1.0 Universal, as the repository's \path{RIGHTS.md} states. The transcribed words of Josephine and Edward Hopper: © Heirs of Josephine N. Hopper, licensed by Artists Rights Society (ARS), New York; quoted here for criticism and study and not licensed onward. The place coordinates in the travels figure: © OpenStreetMap contributors, ODbL 1.0. The museum records cited: the museums' own, retrieved from their public APIs.
\endgroup
