  ...
  build: {
    rollupOptions: {
      ...
      input: {
        ...
        notebookGarrulities: resolve(import.meta.dirname, 'diaries/garrulities/index.html'),
        notebookThreeWashSq: resolve(import.meta.dirname, 'diaries/three-wash-sq/index.html'),
        notebookBattleOfWashSq: resolve(import.meta.dirname, 'diaries/battle-of-wash-sq/index.html'),
        notebookBlackNotebook: resolve(import.meta.dirname, 'diaries/black-notebook/index.html'),
      },
    },
  },
  server: {
